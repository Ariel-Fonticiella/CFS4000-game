...
//We use drawCharacter function then set the fillStyle and use
...
function drawCharacter() {
  ...
  if (rightKey) character.x += 5; // Is the Left or Right key pressed? If so, move 5px in that direction.
